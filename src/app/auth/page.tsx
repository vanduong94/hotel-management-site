    ...
    <section className="container mx-auto">
      <div className="p-6 space-y-4 md:space-y-6 sm:p-8 w-80 md:w-[70%] mx-auto">
        ...
        <form action="" className="space-y-4 md:space-y-6">
          <input type="email" name="email" id="email" placeholder="name@company.com" className={inputStyles} />
          <input type="text" name="name" id="name" placeholder="John Doe" className={inputStyles} />
          <input type="password" name="password" id="password" placeholder="password" className={inputStyles} required minLength={6}/>
